(function (global, factory) {
  ...
  fixRegExpWellKnownSymbolLogic$3('replace', function (_, nativeReplace, maybeCallNative) {
    ...
    function replace(searchValue, replaceValue) {
      ...
      var replacer = isNullOrUndefined$a(searchValue) ? undefined : getMethod$7(searchValue, REPLACE);
      return replacer ? call$i(replacer, searchValue, O, replaceValue) : call$i(nativeReplace, toString$a(O), searchValue, replaceValue);
    },
    ...
    function (string, replaceValue) {
      ...
      for (var i = 0; i < results.length; i++) {
        ...
        if (functionalReplace) {
          ...
          var replacement = toString$a(apply$3(replaceValue, undefined, replacerArgs));
        } else {
  ...
  var BASE_FORCED = DESCRIPTORS$b && (!CORRECT_NEW || MISSED_STICKY || UNSUPPORTED_DOT_ALL || UNSUPPORTED_NCG || fails$m(function () {
    re2[MATCH$2] = false;
  ...
  fixRegExpWellKnownSymbolLogic$2('split', function (SPLIT, nativeSplit, maybeCallNative) {
    ...
    function split(separator, limit) {
      ...
      var splitter = isNullOrUndefined$9(separator) ? undefined : getMethod$6(separator, SPLIT);
      return splitter ? call$h(splitter, separator, O, limit) : call$h(internalSplit, toString$8(O), separator, limit);
    },
    ...
    function (string, limit) {
      ...
      while (q < S.length) {
        ...
        var e;
        if (z === null || (e = min$2(toLength$5(splitter.lastIndex + (UNSUPPORTED_Y ? q : 0)), S.length)) === p) {
  ...
  var URLSearchParamsState = function URLSearchParamsState(init) {
    ...
    this.url = null;
    if (init !== undefined) {
      if (isObject$e(init)) this.parseObject(init);else this.parseQuery(typeof init == 'string' ? charAt$1(init, 0) === '?' ? stringSlice$4(init, 1) : init : $toString$1(init));
    }
  };
    ...
    parseObject: function parseObject(object) {
      ...
      if (iteratorMethod) {
        ...
        while (!(step = call$g(next, iterator)).done) {
          ...
          if ((first = call$g(entryNext, entryIterator)).done || (second = call$g(entryNext, entryIterator)).done || !call$g(entryNext, entryIterator).done) throw TypeError$4('Expected sequence with length 2');
          push$2(this.entries, {
            key: $toString$1(first.value),
            value: $toString$1(second.value)
          });
        }
      } else for (var key in object) if (hasOwn$c(object, key)) {
        push$2(this.entries, {
          key: key,
  ...
  defineBuiltIns$4(URLSearchParamsPrototype, {
  ...
  defineBuiltIn$8(URLSearchParamsPrototype, ITERATOR$3, URLSearchParamsPrototype.entries, {
    name: 'entries'
  });
  ...
  fixRegExpWellKnownSymbolLogic$1('search', function (SEARCH, nativeSearch, maybeCallNative) {
    ...
    function search(regexp) {
      ...
      var searcher = isNullOrUndefined$8(regexp) ? undefined : getMethod$5(regexp, SEARCH);
  ...
  var percentEncode = function percentEncode(chr, set) {
    ...
    return code > 0x20 && code < 0x7F && !hasOwn$b(set, chr) ? chr : encodeURIComponent(chr);
  };
  ...
  var isWindowsDriveLetter = function isWindowsDriveLetter(string, normalized) {
    var second;
    return string.length == 2 && exec$1(ALPHA, charAt(string, 0)) && ((second = charAt(string, 1)) == ':' || !normalized && second == '|');
  };

  // https://url.spec.whatwg.org/#start-with-a-windows-drive-letter
  var startsWithWindowsDriveLetter = function startsWithWindowsDriveLetter(string) {
    var third;
    return string.length > 1 && isWindowsDriveLetter(stringSlice$3(string, 0, 2)) && (string.length == 2 || (third = charAt(string, 2)) === '/' || third === '\\' || third === '?' || third === '#');
  };
        ...
        switch (state) {
          ...
          case SCHEME:
            if (chr && (exec$1(ALPHANUMERIC, chr) || chr == '+' || chr == '-' || chr == '.')) {
              ...
              if (stateOverride && (url.isSpecial() != hasOwn$b(specialSchemes, buffer) || buffer == 'file' && (url.includesCredentials() || url.port !== null) || url.scheme == 'file' && !url.host)) return;
              url.scheme = buffer;
              if (stateOverride) {
          ...
          case FILE:
            ...
            if (chr == '/' || chr == '\\') state = FILE_SLASH;else if (base && base.scheme == 'file') {
              if (chr == EOF) {
                ...
                if (!startsWithWindowsDriveLetter(join$1(arraySlice$4(codePoints, pointer), ''))) {
                  url.host = base.host;
                  url.path = arraySlice$4(base.path);
                  url.shortenPath();
                }
          ...
          case FILE_SLASH:
            ...
            if (base && base.scheme == 'file' && !startsWithWindowsDriveLetter(join$1(arraySlice$4(codePoints, pointer), ''))) {
  ...
  if (DESCRIPTORS$8 && isCallable$k(NativeSymbol) && (!('description' in SymbolPrototype) ||
  // Safari 12 bug
  NativeSymbol().description !== undefined)) {
    ...
    var SymbolWrapper = function Symbol() {
      ...
      var result = isPrototypeOf$3(SymbolPrototype, this) ? new NativeSymbol(description)
    ...
    defineBuiltInAccessor$3(SymbolPrototype, 'description', {
      ...
      get: function description() {
        ...
        var desc = NATIVE_SYMBOL$2 ? stringSlice$2(string, 7, -1) : replace$1(string, regexp, '$1');
  ...
  fixRegExpWellKnownSymbolLogic('match', function (MATCH, nativeMatch, maybeCallNative) {
    ...
    function match(regexp) {
      ...
      var matcher = isNullOrUndefined$7(regexp) ? undefined : getMethod$4(regexp, MATCH);
      return matcher ? call$e(matcher, regexp, O) : new RegExp(regexp)[MATCH](toString$5(O));
    },
  ...
  module.exports = function (input, pref) {
    var fn, val;
    if (pref === 'string' && isCallable$e(fn = input.toString) && !isObject$c(val = call$b(fn, input))) return val;
    if (isCallable$e(fn = input.valueOf) && !isObject$c(val = call$b(fn, input))) return val;
    if (pref !== 'string' && isCallable$e(fn = input.toString) && !isObject$c(val = call$b(fn, input))) return val;
  ...
  module.exports = !!Object.getOwnPropertySymbols && !fails$e(function () {
    var symbol = Symbol();
  ...
  objectGetOwnPropertyDescriptor.f = DESCRIPTORS$6 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
    ...
    if (hasOwn$8(O, P)) return createPropertyDescriptor$2(!call$9(propertyIsEnumerableModule.f, O, P), O[P]);
  };
  ...
  var CONFIGURABLE_FUNCTION_NAME$1 = require('../internals/function-name').CONFIGURABLE;
  ...
  Function.prototype.toString = makeBuiltIn$2(function toString() {
    return isCallable$d(this) && getInternalState(this).source || inspectSource$2(this);
  }, 'toString');
  ...
  var objectKeysInternal = function (object, names) {
    ...
    var result = [];
    var key;
    for (key in O) !hasOwn$6(hiddenKeys$3, key) && hasOwn$6(O, key) && push(result, key);
  ...
  var isForced$3 = function isForced(feature, detection) {
    ...
    return value == POLYFILL ? true : value == NATIVE ? false : isCallable$b(detection) ? fails$a(detection) : !!detection;
  };
  ...
  */
  ...
  module.exports = !construct || fails$8(function () {
    var called;
  ...
  var speciesConstructor$3 = function (O, defaultConstructor) {
    ...
    var S;
    return C === undefined || isNullOrUndefined$3(S = anObject$8(C)[SPECIES$1]) ? defaultConstructor : aConstructor(S);
  };
  ...
  $$c({
    ...
    slice: function slice(start, end) {
      ...
      var result = new (speciesConstructor$2(this, ArrayBuffer$1))(toLength(fin - first));
  ...
  var onFreeze = function onFreeze(it) {
    if (FREEZING$1 && REQUIRED && isExtensible$1(it) && !hasOwn$4(it, METADATA)) setMetadata(it);
    return it;
  };
  ...
  module.exports = function (CONSTRUCTOR_NAME, wrapper, common) {
    ...
    var REPLACE = isForced$1(CONSTRUCTOR_NAME, !isCallable$9(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$4(function () {
    ...
    if (REPLACE) {
      ...
      if (!ACCEPT_ITERABLES) {
        Constructor = wrapper(function (dummy, iterable) {
          ...
          if (!isNullOrUndefined$2(iterable)) iterate$4(iterable, that[ADDER], {
            that: that,
            AS_ENTRIES: IS_MAP
          });
          return that;
  ...
  module.exports = {
    getConstructor: function getConstructor(wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
      var Constructor = wrapper(function (that, iterable) {
        ...
        if (!isNullOrUndefined$1(iterable)) iterate$3(iterable, that[ADDER], {
          that: that,
          AS_ENTRIES: IS_MAP
        });
      });
  ...
  module.exports = isCallable$7(WeakMap$2) && /native code/.test(String(WeakMap$2));
  ...
  var functionUncurryThisAccessor = function (object, key, method) {
    try {
      // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
      return uncurryThis$2(aCallable$6(Object.getOwnPropertyDescriptor(object, key)[method]));
    } catch (error) {/* empty */}
  };
  ...
  if (!set || !clear) {
    ...
    } else if (global$5.addEventListener && isCallable$4(global$5.postMessage) && !global$5.importScripts && $location && $location.protocol !== 'file:' && !fails$1(globalPostMessageDefer)) {
  ...
  var NON_GENERIC = !!NativePromiseConstructor$4 && fails(function () {
